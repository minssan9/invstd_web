...
const commonRouter = [
  {path: '/main-about', component: () => import(/* webpackChunkName: "en9door_common" */'@/views/main/main-about.vue')},
  {path: '/charts/line', component: () => import(/* webpackChunkName: "en9door_common" */'@/views/charts/LineChartSample.vue')},
  // //common
